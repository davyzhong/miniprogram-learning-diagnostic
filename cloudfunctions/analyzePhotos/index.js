...
const { analysisErrorMessage, isRetryableError, isNonRetryableError, isUserFacingAnalysisError } = require('./error-classify');
...
exports.main = async (event) => {
  ...
  try {
    ...
    await logErrorEvent({ function: 'analyzePhotos', action: 'main', message: '图片分析失败', error: err, studentId: event.studentId || '', reportId: event.reportId || '' });
