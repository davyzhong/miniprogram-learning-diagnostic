...
// 数据来源：data/math/bottleneck-taxonomy-v2.seed.json
module.exports = {
  "version": "0.2.0",
  "updatedAt": "2026-07-17",
  "subject": "math",
  "scope": "S1小学数学细颗粒度学习卡点首批种子库。",
  "sourceDocs": [
    "数学试卷分析/Learning_Diagnostic_MVP_诊断报告.md",
    "数学试卷分析/S1_学习卡点诊断报告_第二版.md",
  ...
  "bottlenecks": [
    ...
    },
    {
      ...
      "sourceEvidence": [
        "《S1_学习卡点诊断报告_第二版》运算顺序与简便计算类错题复核"
      ],
      "categoryId": "MATH-CAT-CALC-RULE",
      "categoryTitle": "计算规则",
    ...
    },
    {
      ...
      "sourceEvidence": [
        "《S1_学习卡点诊断报告_第二版》比例应用题复核：剩余与已运之比 5:3 类问题"
      ],
      "categoryId": "MATH-CAT-MODEL",
      "categoryTitle": "数量关系建模",
      "familyId": "MATH-FAM-RATIO-MEANING",
