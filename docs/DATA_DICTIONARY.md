...
| `generationProgress` | Object | 否 | `null` | 分批生成进度（v2）：`{ completedBatches, totalBatches, succeededBatches }`，供前端轮询展示 | `{"completedBatches":3,"totalBatches":5,"succeededBatches":3}` |
