...
> 2026-07-02 文档同步：运行时不再引用小程序主包内的静态 hero 图；当前界面截图保留在 `docs/user-guide/images/`，用于文档说明和验收对照。
...
1. 家庭今日总览行动卡：点击进入当前最重要行动。当前截图见 ![家庭学习工作台](../../user-guide/images/01-family-workbench.png)。
...
1. 个人行动摘要卡：点击进入今日主行动。当前截图见 ![个人学习档案](../../user-guide/images/02-student-profile.png)。
...
- 家庭页顶部出现行动总览卡，点击可进入真实行动。
- 钟青羽显示在钟筱雨前面。
- 孩子卡片不再展示冗长的最近试卷覆盖文本。
- 个人页出现个人行动摘要、今日行动、最新诊断报告、行动队列、三科学科入口。
- 个人页所有卡片均可点击。
