...
- Design spec: `docs/subject-design/S1验证任务包与分页验证卷设计文档.md`
- Existing math design: `docs/subject-design/S1数学学习地图与资源库升级详细设计.md`
- Existing Chinese design: `docs/subject-design/S1语文错项驱动诊断与验证设计文档.md`
