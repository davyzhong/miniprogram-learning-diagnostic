...
function seedDatabase() {
  return createDatabase({
    students: [
      { _id: 'student-1', _openid: 'owner-1', name: 'S1', grade: 6, createdAt: '2026-06-01T10:00:00Z', updatedAt: '2026-06-12T10:00:00Z' },
...
test('viewer can read dashboard for a joined child with role-aware permissions', async () => {
  ...
  assert.equal(result.student.name, 'S1')
...
test('timeline sorts papers by generated time while preserving paper date', async () => {
  const db = createDatabase({
    students: [{ _id: 'student-1', _openid: 'owner-1', name: 'S1', grade: 6 }],
...
function seedHomeDashboardDatabase() {
  return createDatabase({
    students: [
      { _id: 'student-1', _openid: 'owner-1', name: 'S1', grade: 6, createdAt: '2026-06-01T10:00:00Z' },
      { _id: 'student-2', _openid: 'owner-1', name: 'S2', grade: 4, createdAt: '2026-06-02T10:00:00Z' },
