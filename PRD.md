...
> 版本：v3.1 | 日期：2026-07-18 | 状态：私有内测持续迭代；数学诊断闭环、语文具体错项复测、英语词汇双维闭环已落地。常规自动化测试 1008/1008 通过，JS 语法检查 313 个文件通过，主包 791 KB/1200 KB；B01 202 项与 B02 996 项 emoji 已完成 Android/iOS 目标设备验证
>
...
| 主包体积预算 | ✅ | `npm run check:size`（791 KB / 1200 KB，预算 2026-07-18 由 800 KB 上调） |
