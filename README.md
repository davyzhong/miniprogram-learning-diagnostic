...
- ✅ 学科隔离：数学/语文/英语三科独立，学科入口作为二级查看入口
...
- ✅ 自动化测试：136 个常规用例通过，JS 语法检查 52 文件通过
...
├── tests/                       # 自动化测试（136 个常规用例 + 真实图片 E2E 脚本）
...
| 文档 | 说明 |
|------|------|
| [PRD.md](./PRD.md) | 产品设计文档 v2.5：学习档案首页、页面设计、数据模型、异步架构、学习记录、实现状态总览 |
