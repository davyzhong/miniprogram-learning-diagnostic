...
const student = { _id: 'student-km', name: 'S1', grade: 6, createdAt: NOW, avatarColor: 'blue' }
...
// === 验收点 ===
const studentQ = 'studentId=student-km&studentName=S1'
...
const checks = [
  ...
  },
  {
    ...
    route: `/pages/subject-home/subject-home?${studentQ}&subject=math&subjectName=%E6%95%B0%E5%AD%A6&studentName=S1&grade=6`,
    wait: 2000,
    expect: { text: ['知识地图'] }
  },
  {
