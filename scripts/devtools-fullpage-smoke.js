...
const student = { _id: 'student-smoke', name: 'S1', grade: 6, createdAt: NOW, avatarColor: 'blue' }
...
const members = [{ _id: 'member-1', studentId: student._id, ownerOpenId: 'o1', memberOpenId: 'o1', role: 'owner', status: 'active', displayName: 'S1家长', createdAt: NOW }]

// ---- 17 个页面的路由定义（含必要 query 参数）----
const studentQ = 'studentId=student-smoke&studentName=S1'
const pages = [
