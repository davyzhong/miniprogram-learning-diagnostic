...
async function installFamilyDensityMocks(miniProgram) {
  await miniProgram.evaluate(() => {
    ...
    const students = [
      { _id: 'student-density-one', name: 'S1同学的超长学习档案姓名', grade: 6, createdAt: now, role: 'owner', memberCount: 3, permissions },
      { _id: 'student-density-two', name: 'S2同学的第二个超长姓名', grade: 4, createdAt: '2026-07-11T10:30:00+08:00', role: 'owner', memberCount: 2, permissions }
    ]
...
async function main() {
  ...
  try {
    ...
    const historyPage = await miniProgram.reLaunch(
      '/pages/upload-history/upload-history?studentId=student-density-one&studentName=S1%E5%90%8C%E5%AD%A6%E7%9A%84%E8%B6%85%E9%95%BF%E5%AD%A6%E4%B9%A0%E6%A1%A3%E6%A1%88%E5%A7%93%E5%90%8D'
    )
