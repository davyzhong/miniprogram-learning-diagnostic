...
const student = { _id: 'student-e2e', name: 'S1', grade: 6, createdAt: NOW, avatarColor: 'blue' }
...
const members = [
  { _id: 'm1', studentId: student._id, ownerOpenId: 'o1', memberOpenId: 'o1', role: 'owner', status: 'active', displayName: 'S1家长', createdAt: NOW },
  { _id: 'm2', studentId: student._id, ownerOpenId: 'o1', memberOpenId: 'o2', role: 'viewer', status: 'active', displayName: '共同查看家长', createdAt: NOW },
]

// === 17 个页面 + 期望的渲染断言 ===
const studentQ = 'studentId=student-e2e&studentName=S1'
const pages = [
  {
    name: 'index 首页/家庭工作台',
    route: '/pages/index/index',
    expect: {
      text: ['家庭学习工作台', 'S1', '添加孩子'],
      notText: ['加载中', '页面不存在'],
      minChildren: 1,
    },
  },
...
const scenarios = [
  {
    ...
    steps: [
      { route: '/pages/index/index', wait: 4000, expect: { text: ['家庭学习工作台', 'S1'] } },
      { action: 'tapByText', selector: '.child-card', text: 'S1', wait: 1500, expect: { path: 'pages/student-profile/student-profile' } },
  ...
  },
  {
    ...
    steps: [
      { route: `/pages/subject-home/subject-home?${studentQ}&subject=math&subjectName=%E6%95%B0%E5%AD%A6&studentName=S1&grade=6`, wait: 1800, expect: { text: ['拍照诊断', '默认试卷', '学习记录'] } },
      { action: 'tapByText', selector: '.tool-item', text: '拍照诊断', wait: 1200, expect: { path: 'pages/upload/upload' } },
      { action: 'relaunch', route: `/pages/subject-home/subject-home?${studentQ}&subject=math&subjectName=%E6%95%B0%E5%AD%A6&studentName=S1&grade=6`, wait: 1500 },
  ...
  },
  {
    ...
    steps: [
      { route: `/pages/student-profile/student-profile?${studentQ}`, wait: 1800, expect: { text: ['S1', '个人学习工作台', '学习卡点修复'] } },
