...
const OUTPUTS = [
  path.join(ROOT, 'data/english/case-s1-pep-vocabulary.seed.json'),
  path.join(ROOT, 'cloudfunctions/englishVocabulary/case-s1-pep-vocabulary.json')
]
